...
public sealed class Example : MonoBehaviour
{
    ...
    public string informationInter;
    ...
    private int mByteDanceADState = 0; //0,无准备  1,准备中  2 准备好  3 播放中  4 播放完毕  5关闭但没播放完  6关闭并播放完成
    private int mInterADState = 0; //0,无准备  1,准备中  2 准备好  3 播放中 4 关闭 5 失败

    public int GetState()
    {
        return mByteDanceADState;
    }

    public int GetInterADState()
    {
        return mInterADState;
    }
    ...
    public void LoadExpressInterstitialAd()
    {
        ...
        //  this.inputX = GameObject.Find("InputFieldW").GetComponent<InputField>();
        // this.inputY = GameObject.Find("InputFieldH").GetComponent<InputField>();
    ...
    public void ShowExpressInterstitialAd()
    {
        ...
        // this.inputX = GameObject.Find("InputFieldX").GetComponent<InputField>();
        // this.inputY = GameObject.Find("InputFieldY").GetComponent<InputField>();
    ...
    private sealed class RewardVideoAdListener : IRewardVideoAdListener
    {
        ...
        public void OnError(int code, string message)
        {
            ...
            this.example.information = "OnRewardError: " + message;
        }

        public void OnRewardVideoAdLoad(RewardVideoAd ad)
        {
            Debug.Log("OnRewardVideoAdLoad");
            this.example.information = "OnRewardVideoAdLoad";
        ...
        public void OnRewardVideoCached()
        {
            ...
            this.example.information = "OnRewardVideoCached";
    ...
    private sealed class ExpressRewardVideoAdListener : IRewardVideoAdListener
    {
        ...
        public void OnExpressRewardVideoAdLoad(ExpressRewardVideoAd ad)
        {
            ...
            this.example.information = "OnRewardExpressVideoAdLoad";
        ...
        public void OnRewardVideoCached()
        {
            ...
            this.example.information = "OnExpressRewardVideoCached";
#if UNITY_IOS
...
#endif
            this.example.mByteDanceADState = 2;
    ...
    private sealed class FullScreenVideoAdListener : IFullScreenVideoAdListener
    {
        ...
        public void OnError(int code, string message)
        {
            ...
            this.example.information = "OnFullScreenError: " + message;
        }

        public void OnFullScreenVideoAdLoad(FullScreenVideoAd ad)
        {
            Debug.Log("OnFullScreenAdLoad");
            this.example.information = "OnFullScreenAdLoad";
        ...
        public void OnFullScreenVideoCached()
        {
            ...
            this.example.information = "OnFullScreenVideoCached";
    ...
    private sealed class ExpressFullScreenVideoAdListener : IFullScreenVideoAdListener
    {
        ...
        public void OnExpressFullScreenVideoAdLoad(ExpressFullScreenVideoAd ad)
        {
            ...
            this.example.information = "OnExpressFullScreenAdLoad";
    ...
    private sealed class ExpressAdListener : IExpressAdListener
    {
        ...
        public ExpressAdListener(Example example, int type)
        {
            this.example = example;
            this.type = type;
            this.example.information = "ExpressAdListener";
        }
        public void OnError(int code, string message)
        {
            {
                 Debug.LogError("onExpressAdError: " + message);
                this.example.information = "onExpressAdError";
            }
        ...
        public void OnExpressAdLoad(List<ExpressAd> ads)
        {
            ...
            this.example.information = "OnExpressAdLoad";
        ...
        public void OnExpressBannerAdLoad(ExpressBannerAd ad)
        {
            ...
            this.example.information = "OnExpressBannerAdLoad";
        ...
        public void OnExpressInterstitialAdLoad(ExpressInterstitialAd ad)
        {
            ...
            this.example.information = "OnExpressInterstitialAdLoad";
            this.example.informationInter = "OnExpressInterstitialAdLoad";
            ad.SetExpressInteractionListener(
                new ExpressAdInteractionListener(this.example, 2));
            ad.SetDownloadListener(
                new AppDownloadListener(this.example));
            this.example.iExpressInterstitialAd = ad;
             this.example.mInterADState = 2;
        }
#else
#endif
    }
    ...
    private sealed class ExpressAdDislikeCallback : IDislikeInteractionListener
    {
        ...
        public void OnCancel()
        {
            ...
            this.example.information = "ExpressAdDislikeCallback cancle:" + type;
        }

        public void OnRefuse()
        {
            Debug.LogError("express dislike onRefuse");
            this.example.information = "ExpressAdDislikeCallback refuse:" + type;
        }

        public void OnSelected(int var1, string var2)
        {
            Debug.LogError("express dislike OnSelected:" + var2);
            this.example.information = "ExpressAdDislikeCallback OnSelected:" + type;
#if UNITY_IOS
    ...
    private sealed class NativeAdInteractionListener : IInteractionAdInteractionListener
    {
        ...
        public void OnAdShow()
        {
            ...
            this.example.information = "NativeAd show";
        }

        public void OnAdClicked()
        {
            Debug.Log("NativeAd click");
            this.example.information = "NativeAd click";
        }

        public void OnAdDismiss()
        {
            Debug.Log("NativeAd close");
            this.example.information = "NativeAd close";
    ...
    private sealed class NativeAdListener : INativeAdListener
    {
        ...
        public void OnError(int code, string message)
        {
            ...
            this.example.information = "OnNativeAdError: " + message;
        }
        ...
        public void OnNativeAdLoad(AndroidJavaObject list,NativeAd ad)
        {
            ...
            this.example.information = "OnNativeAdLoad";
    ...
    private sealed class FullScreenAdInteractionListener : IFullScreenVideoAdInteractionListener
    {
        ...
        public void OnAdShow()
        {
            ...
            this.example.information = "fullScreenVideoAd show";
        }

        public void OnAdVideoBarClick()
        {
            Debug.Log("fullScreenVideoAd bar click");
            this.example.information = "fullScreenVideoAd bar click";
        }

        public void OnAdClose()
        {
            Debug.Log("fullScreenVideoAd close");
            this.example.information = "fullScreenVideoAd close";
        ...
        public void OnVideoComplete()
        {
            ...
            this.example.information = "fullScreenVideoAd complete";
        }

        public void OnVideoError()
        {
            Debug.Log("fullScreenVideoAd OnVideoError");
            this.example.information = "fullScreenVideoAd OnVideoError";
        }

        public void OnSkippedVideo()
        {
            Debug.Log("fullScreenVideoAd OnSkippedVideo");
            this.example.information = "fullScreenVideoAd skipped";
    ...
    private sealed class RewardAdInteractionListener : IRewardAdInteractionListener
    {
        ...
        public void OnAdShow()
        {
            ...
            this.example.information = "rewardVideoAd show";
        }

        public void OnAdVideoBarClick()
        {
            Debug.Log("rewardVideoAd bar click");
            this.example.information = "rewardVideoAd bar click";
        }

        public void OnAdClose()
        {
            Debug.Log("rewardVideoAd close");
            this.example.information = "rewardVideoAd close";
            this.example.rewardAd = null;

#if UNITY_IOS
            this.example.expressRewardAd = null;
#endif
            //if(this.example.mByteDanceADState == 4 )
                this.example. mByteDanceADState = 6;
           // else
              //  this.example. mByteDanceADState = 5;
        }

        public void OnVideoComplete()
        {
            Debug.Log("rewardVideoAd complete");
            this.example.information = "rewardVideoAd complete";
            this.example. mByteDanceADState = 4;
        }

        public void OnVideoError()
        {
            Debug.LogError("rewardVideoAd error");
            this.example.information = "rewardVideoAd error";
        }
    ...
    private sealed class SplashAdListener : ISplashAdListener
    {
        ...
        public void OnError(int code, string message)
        {
            ...
            this.example.information = "Onerror:" + code + ":" + message;
        }
        ...
        public void OnSplashAdLoad(BUSplashAd ad)
        {
            if (ad != null)
            {
                ...
                this.example.information = "OnLoad";
#if UNITY_IOS
        ...
        if (ad != null && this.splashAdManager != null && this.activity != null)
            {
                this.example.information = "Splash OnLoad";
        ...
        {
            this.example.information = "Splash destorySplashView";
            ...
            public void OnAdClicked(int type)
            {
                ...
                this.example.information = "Splash OnAdClicked";
#if UNITY_ANDROID
            ...
            public void OnAdShow(int type)
            {
                ...
                this.example.information = "Splash OnAdShow";
            }
            ...
            public void OnAdSkip()
            {
                ...
                this.example.information = "Splash OnAdSkip";
                DestorySplash();
            }
            ...
            public void OnAdTimeOver()
            {
                ...
                this.example.information = "Splash OnAdTimeOver";
                DestorySplash();
            }

            public void OnAdClose()
            {
                this.example.information = "OnAdClose";
                DestorySplash();
            }
        }
    }
...
private sealed class ExpressSplashAdInteractionListener : ISplashAdInteractionListener
{
        ...
        public void OnAdClicked(int type)
    {
        ...
        this.example.information = "OnAdClicked";
    }
        ...
        public void OnAdShow(int type)
    {
        ...
        this.example.information = "OnAdShow";
    }
        ...
        public void OnAdSkip()
    {
        ...
        this.example.information = "OnAdSkip";
    }
        ...
        public void OnAdTimeOver()
    {
        ...
        this.example.information = "OnAdTimeOver";
    }
     ...
     private sealed class AppDownloadListener : IAppDownloadListener
    {
            ...
            long totalBytes, string fileName, string appName)
        {
            ...
            this.example.information = "下载完成，点击下载区域重新下载";
        }
